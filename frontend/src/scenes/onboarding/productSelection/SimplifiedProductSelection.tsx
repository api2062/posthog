...
export function SimplifiedProductSelection(): JSX.Element {
    ...
    const handlePickProduct = (index: number): void => {
        ...
        <div className="flex flex-col flex-1 w-full min-h-full p-4 items-center justify-center bg-primary overflow-x-hidden">
            ...
            <div className="relative flex flex-col items-center justify-center flex-grow w-full max-w-2xl">
                ...
                <p className="text-center text-muted mb-8">
                    {hasBrowsingHistory
                        ? "We've got a hunch about where to start. Prove us wrong."
                            ...
                            {isNauseous ? (
                                ...
                                <div className="flex flex-col items-center justify-center h-full gap-4 p-6">
                                    ...
                                    <style>{`
                                        ...
                                        .animate-buzz {
                                            animation: buzz 0.12s infinite linear;
                                        }
                                    `}</style>
                                </div>
                            ) : (
                                ...
                                <div className="flex h-full">
                                    ...
                                    <div className="flex-1 flex flex-col justify-between p-5">
                                        <div>
                                            ...
                                            <h2 className="text-xl font-bold mb-3">{spotlightDescription}</h2>
