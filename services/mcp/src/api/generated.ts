...
export namespace Schemas {
    ...
    * `other` - Other
    ...
    export type EventMetadataPropertyFilterType = typeof EventMetadataPropertyFilterType[keyof typeof EventMetadataPropertyFilterType];
    ...
    export type DataWarehousePropertyFilterType = typeof DataWarehousePropertyFilterType[keyof typeof DataWarehousePropertyFilterType];
    ...
    export type DataWarehousePersonPropertyFilterType = typeof DataWarehousePersonPropertyFilterType[keyof typeof DataWarehousePersonPropertyFilterType];
    ...
    export type ErrorTrackingIssueFilterType = typeof ErrorTrackingIssueFilterType[keyof typeof ErrorTrackingIssueFilterType];
    ...
    export type ActorsPropertyTaxonomyQueryKind = typeof ActorsPropertyTaxonomyQueryKind[keyof typeof ActorsPropertyTaxonomyQueryKind];
    ...
    export type ResultCustomizationByValueAssignmentBy = typeof ResultCustomizationByValueAssignmentBy[keyof typeof ResultCustomizationByValueAssignmentBy];
    ...
    export type ResultCustomizationByPositionAssignmentBy = typeof ResultCustomizationByPositionAssignmentBy[keyof typeof ResultCustomizationByPositionAssignmentBy];
    ...
    export type FunnelExclusionEventsNodeKind = typeof FunnelExclusionEventsNodeKind[keyof typeof FunnelExclusionEventsNodeKind];
    ...
    export type FunnelExclusionActionsNodeKind = typeof FunnelExclusionActionsNodeKind[keyof typeof FunnelExclusionActionsNodeKind];
    ...
    export type FunnelConversionWindowTimeUnit = typeof FunnelConversionWindowTimeUnit[keyof typeof FunnelConversionWindowTimeUnit];
    ...
    export type RetentionDashboardDisplayType = typeof RetentionDashboardDisplayType[keyof typeof RetentionDashboardDisplayType];
    ...
    export type WebAnalyticsOrderByDirection = typeof WebAnalyticsOrderByDirection[keyof typeof WebAnalyticsOrderByDirection];
    ...
    export type FunnelCorrelationActorsQueryKind = typeof FunnelCorrelationActorsQueryKind[keyof typeof FunnelCorrelationActorsQueryKind];
    ...
    export type FunnelCorrelationResultsType = typeof FunnelCorrelationResultsType[keyof typeof FunnelCorrelationResultsType];
    ...
    export interface ActorsQuery {
      ...
      orderBy?: string[] | null;
      /** Currently only person filters supported. No filters for querying groups. See `filter_conditions()` in actor_strategies.py. */
      properties?: (PersonPropertyFilter | CohortPropertyFilter | HogQLPropertyFilter | EmptyPropertyFilter)[] | PropertyGroupFilterValue | null;
      response?: ActorsQueryResponse | null;
      /** @nullable */
      search?: string | null;
      /** @nullable */
    ...
    * `product_tours` - product_tours
     */
    export type CreationContextDaaEnum = typeof CreationContextDaaEnum[keyof typeof CreationContextDaaEnum];


    export const CreationContextDaaEnum = {
    ...
    * `Running` - Running
    ...
    export type ErrorTrackingIssueAssigneeType = typeof ErrorTrackingIssueAssigneeType[keyof typeof ErrorTrackingIssueAssigneeType];
    ...
    export type WebExternalClicksTableQueryKind = typeof WebExternalClicksTableQueryKind[keyof typeof WebExternalClicksTableQueryKind];
    ...
    export const WebExternalClicksTableQueryOrderByItem = {...WebAnalyticsOrderByFields,...WebAnalyticsOrderByDirection,} as const
    export interface WebExternalClicksTableQuery {
      ...
      modifiers?: HogQLQueryModifiers | null;
      /** @nullable */
      orderBy?: typeof WebExternalClicksTableQueryOrderByItem[keyof typeof WebExternalClicksTableQueryOrderByItem] [] | null;
      properties: (EventPropertyFilter | PersonPropertyFilter | SessionPropertyFilter | CohortPropertyFilter)[];
    ...
    export type WebVitalsPathBreakdownQueryKind = typeof WebVitalsPathBreakdownQueryKind[keyof typeof WebVitalsPathBreakdownQueryKind];
    ...
    export const WebVitalsPathBreakdownQueryOrderByItem = {...WebAnalyticsOrderByFields,...WebAnalyticsOrderByDirection,} as const
    export interface WebVitalsPathBreakdownQuery {
      ...
      modifiers?: HogQLQueryModifiers | null;
      /** @nullable */
      orderBy?: typeof WebVitalsPathBreakdownQueryOrderByItem[keyof typeof WebVitalsPathBreakdownQueryOrderByItem] [] | null;
    ...
    export type SessionAttributionExplorerQueryKind = typeof SessionAttributionExplorerQueryKind[keyof typeof SessionAttributionExplorerQueryKind];
    ...
    export type RevenueAnalyticsBreakdownType = typeof RevenueAnalyticsBreakdownType[keyof typeof RevenueAnalyticsBreakdownType];
    ...
    export type RevenueAnalyticsGrossRevenueQueryKind = typeof RevenueAnalyticsGrossRevenueQueryKind[keyof typeof RevenueAnalyticsGrossRevenueQueryKind];
    ...
    export type RevenueAnalyticsMetricsQueryKind = typeof RevenueAnalyticsMetricsQueryKind[keyof typeof RevenueAnalyticsMetricsQueryKind];
    ...
    export type RevenueAnalyticsMRRQueryKind = typeof RevenueAnalyticsMRRQueryKind[keyof typeof RevenueAnalyticsMRRQueryKind];
    ...
    export type RevenueAnalyticsOverviewQueryKind = typeof RevenueAnalyticsOverviewQueryKind[keyof typeof RevenueAnalyticsOverviewQueryKind];
    ...
    export type RevenueAnalyticsTopCustomersGroupBy = typeof RevenueAnalyticsTopCustomersGroupBy[keyof typeof RevenueAnalyticsTopCustomersGroupBy];
    ...
    export type RevenueAnalyticsTopCustomersQueryKind = typeof RevenueAnalyticsTopCustomersQueryKind[keyof typeof RevenueAnalyticsTopCustomersQueryKind];
    ...
    export type RevenueExampleEventsQueryKind = typeof RevenueExampleEventsQueryKind[keyof typeof RevenueExampleEventsQueryKind];
    ...
    export type RevenueExampleDataWarehouseTablesQueryKind = typeof RevenueExampleDataWarehouseTablesQueryKind[keyof typeof RevenueExampleDataWarehouseTablesQueryKind];
    ...
    export type MarketingAnalyticsTableQueryKind = typeof MarketingAnalyticsTableQueryKind[keyof typeof MarketingAnalyticsTableQueryKind];
    ...
    export type MarketingAnalyticsOrderByEnum = typeof MarketingAnalyticsOrderByEnum[keyof typeof MarketingAnalyticsOrderByEnum];
    ...
    export type MarketingAnalyticsAggregatedQueryKind = typeof MarketingAnalyticsAggregatedQueryKind[keyof typeof MarketingAnalyticsAggregatedQueryKind];
    ...
    export type NonIntegratedConversionsTableQueryKind = typeof NonIntegratedConversionsTableQueryKind[keyof typeof NonIntegratedConversionsTableQueryKind];
    ...
    export type ErrorTrackingIssueCorrelationQueryKind = typeof ErrorTrackingIssueCorrelationQueryKind[keyof typeof ErrorTrackingIssueCorrelationQueryKind];
    ...
    export type ExperimentFunnelsQueryResponseKind = typeof ExperimentFunnelsQueryResponseKind[keyof typeof ExperimentFunnelsQueryResponseKind];
    ...
    export type ExperimentTrendsQueryResponseKind = typeof ExperimentTrendsQueryResponseKind[keyof typeof ExperimentTrendsQueryResponseKind];
    ...
    export type EndpointsUsageTableQueryKind = typeof EndpointsUsageTableQueryKind[keyof typeof EndpointsUsageTableQueryKind];
    ...
    export type EndpointsUsageOrderByDirection = typeof EndpointsUsageOrderByDirection[keyof typeof EndpointsUsageOrderByDirection];
    ...
    export const EndpointsUsageTableQueryOrderByItem = {...EndpointsUsageOrderByField,...EndpointsUsageOrderByDirection,} as const
    ...
    * `managed_viewset` - Managed Viewset */
    ...
    export type DatabaseSchemaBatchExportTableType = typeof DatabaseSchemaBatchExportTableType[keyof typeof DatabaseSchemaBatchExportTableType];
    ...
    export type DatabaseSchemaDataWarehouseTableType = typeof DatabaseSchemaDataWarehouseTableType[keyof typeof DatabaseSchemaDataWarehouseTableType];
    ...
    export type DatabaseSchemaEndpointTableType = typeof DatabaseSchemaEndpointTableType[keyof typeof DatabaseSchemaEndpointTableType];
    ...
    export type DatabaseSchemaManagedViewTableType = typeof DatabaseSchemaManagedViewTableType[keyof typeof DatabaseSchemaManagedViewTableType];
    ...
    export type DatabaseSchemaManagedViewTableKind = typeof DatabaseSchemaManagedViewTableKind[keyof typeof DatabaseSchemaManagedViewTableKind];
    ...
    export type DatabaseSchemaPostHogTableType = typeof DatabaseSchemaPostHogTableType[keyof typeof DatabaseSchemaPostHogTableType];
    ...
    export type DatabaseSchemaSystemTableType = typeof DatabaseSchemaSystemTableType[keyof typeof DatabaseSchemaSystemTableType];
    ...
    * `archived` - archived
    ...
    export type EndpointsUsageOverviewQueryKind = typeof EndpointsUsageOverviewQueryKind[keyof typeof EndpointsUsageOverviewQueryKind];
    ...
    export type EndpointsUsageTrendsQueryKind = typeof EndpointsUsageTrendsQueryKind[keyof typeof EndpointsUsageTrendsQueryKind];
    ...
    * `stopped` - Stopped
    ...
    export type ExperimentExposureQueryResponseKind = typeof ExperimentExposureQueryResponseKind[keyof typeof ExperimentExposureQueryResponseKind];
    ...
    * `web_experiments` - web_experiments
    * `product_tours` - product_tours */
      creation_context?: CreationContextDaaEnum;
      /** @nullable */
    ...
    * `flag_evaluates_to` - flag_evaluates_to */
    ...
    export interface FeatureFlagCreateRequestSchema {
      ...
      /** Origin context for this feature flag.
    ...
    * `product_tours` - product_tours */
      creation_context?: CreationContextDaaEnum;
      /** Optional folder short ID to place the feature flag in. */
      _create_in_folder?: string;
      /** Whether to generate a usage dashboard after flag creation. */
      _should_create_usage_dashboard?: boolean;
    }
    ...
    * `transformation` - Transformation */
    ...
    export type InsightActorsQueryOptionsKind = typeof InsightActorsQueryOptionsKind[keyof typeof InsightActorsQueryOptionsKind];
    ...
    export const WebPageURLSearchQueryOrderByItem = {...WebAnalyticsOrderByFields,...WebAnalyticsOrderByDirection,} as const
    ...
    export type WebAnalyticsExternalSummaryQueryKind = typeof WebAnalyticsExternalSummaryQueryKind[keyof typeof WebAnalyticsExternalSummaryQueryKind];
    ...
    * `frequentist` - Frequentist */
     ...
     * * `vercel` - Vercel
     */
    export type OrganizationIntegrationKindEnum = typeof OrganizationIntegrationKindEnum[keyof typeof OrganizationIntegrationKindEnum];
    ...
    * `managed_viewset` - Managed Viewset */
    ...
    export interface PatchedFeatureFlagPartialUpdateRequestSchema {
      ...
      /** Evaluation context tags. Must be a subset of `tags`. */
      evaluation_tags?: string[];
      /** Soft-delete flag state. */
      deleted?: boolean;
      /** Optional folder short ID to place the feature flag in. */
      _create_in_folder?: string;
      /** Whether to generate a usage dashboard when creating metadata. */
      _should_create_usage_dashboard?: boolean;
    }
    ...
    * `other` - Other */
    ...
    export type PatchedSessionRecordingPlaylistRecordingsCounts = {[key: string]: {[key: string]: number | boolean | null}};
    ...
    * `OR` - OR */
    ...
    export type QueryResponseAlternative4Kind = typeof QueryResponseAlternative4Kind[keyof typeof QueryResponseAlternative4Kind];
    ...
    export type QueryResponseAlternative18Kind = typeof QueryResponseAlternative18Kind[keyof typeof QueryResponseAlternative18Kind];
    ...
    export type QueryResponseAlternative19Kind = typeof QueryResponseAlternative19Kind[keyof typeof QueryResponseAlternative19Kind];
    ...
    export type QueryResponseAlternative20Kind = typeof QueryResponseAlternative20Kind[keyof typeof QueryResponseAlternative20Kind];
    ...
    export type QueryResponseAlternative21Kind = typeof QueryResponseAlternative21Kind[keyof typeof QueryResponseAlternative21Kind];
    ...
    export type QueryResponseAlternative40Kind = typeof QueryResponseAlternative40Kind[keyof typeof QueryResponseAlternative40Kind];
    ...
    export type QueryResponseAlternative61Kind = typeof QueryResponseAlternative61Kind[keyof typeof QueryResponseAlternative61Kind];
    ...
    export type QueryResponseAlternative62Kind = typeof QueryResponseAlternative62Kind[keyof typeof QueryResponseAlternative62Kind];
    ...
    export type QueryResponseAlternative72Tables = {[key: string]: DatabaseSchemaPostHogTable | DatabaseSchemaSystemTable | DatabaseSchemaDataWarehouseTable | DatabaseSchemaViewTable | DatabaseSchemaManagedViewTable | DatabaseSchemaBatchExportTable | DatabaseSchemaMaterializedViewTable | DatabaseSchemaEndpointTable};
    ...
    * `$ai_trace` - $ai_trace */
    ...
    export type EnvironmentsDashboardsDestroyFormat = typeof EnvironmentsDashboardsDestroyFormat[keyof typeof EnvironmentsDashboardsDestroyFormat];
    ...
    export type EnvironmentsDashboardsMoveTilePartialUpdateFormat = typeof EnvironmentsDashboardsMoveTilePartialUpdateFormat[keyof typeof EnvironmentsDashboardsMoveTilePartialUpdateFormat];
    ...
    export type EnvironmentsDashboardsCreateFromTemplateJsonCreateFormat = typeof EnvironmentsDashboardsCreateFromTemplateJsonCreateFormat[keyof typeof EnvironmentsDashboardsCreateFromTemplateJsonCreateFormat];
    ...
    export type EnvironmentsDashboardsCreateUnlistedDashboardCreateFormat = typeof EnvironmentsDashboardsCreateUnlistedDashboardCreateFormat[keyof typeof EnvironmentsDashboardsCreateUnlistedDashboardCreateFormat];
    ...
    * `-updated_at` - Updated At (descending)
    ...
    export type EnvironmentsEventsListFormat = typeof EnvironmentsEventsListFormat[keyof typeof EnvironmentsEventsListFormat];
    ...
    export type EnvironmentsEventsValuesRetrieveFormat = typeof EnvironmentsEventsValuesRetrieveFormat[keyof typeof EnvironmentsEventsValuesRetrieveFormat];
    ...
    export type EnvironmentsInsightsRetrieveRefresh = typeof EnvironmentsInsightsRetrieveRefresh[keyof typeof EnvironmentsInsightsRetrieveRefresh];
    ...
    export type EnvironmentsInsightsDestroyFormat = typeof EnvironmentsInsightsDestroyFormat[keyof typeof EnvironmentsInsightsDestroyFormat];
    ...
    export type EnvironmentsInsightsAnalyzeRetrieveFormat = typeof EnvironmentsInsightsAnalyzeRetrieveFormat[keyof typeof EnvironmentsInsightsAnalyzeRetrieveFormat];
    ...
    export type EnvironmentsInsightsSuggestionsRetrieveFormat = typeof EnvironmentsInsightsSuggestionsRetrieveFormat[keyof typeof EnvironmentsInsightsSuggestionsRetrieveFormat];
    ...
    export type EnvironmentsInsightsSuggestionsCreateFormat = typeof EnvironmentsInsightsSuggestionsCreateFormat[keyof typeof EnvironmentsInsightsSuggestionsCreateFormat];
    ...
    export type EnvironmentsInsightsCancelCreateFormat = typeof EnvironmentsInsightsCancelCreateFormat[keyof typeof EnvironmentsInsightsCancelCreateFormat];
    ...
    export type EnvironmentsInsightsMyLastViewedRetrieveFormat = typeof EnvironmentsInsightsMyLastViewedRetrieveFormat[keyof typeof EnvironmentsInsightsMyLastViewedRetrieveFormat];
    ...
    export type EnvironmentsInsightsViewedCreateFormat = typeof EnvironmentsInsightsViewedCreateFormat[keyof typeof EnvironmentsInsightsViewedCreateFormat];
    ...
    export type EnvironmentsPersonsListFormat = typeof EnvironmentsPersonsListFormat[keyof typeof EnvironmentsPersonsListFormat];
    ...
    export type EnvironmentsPersonsRetrieveFormat = typeof EnvironmentsPersonsRetrieveFormat[keyof typeof EnvironmentsPersonsRetrieveFormat];
    ...
    export type EnvironmentsPersonsUpdateFormat = typeof EnvironmentsPersonsUpdateFormat[keyof typeof EnvironmentsPersonsUpdateFormat];
    ...
    export type EnvironmentsPersonsPartialUpdateFormat = typeof EnvironmentsPersonsPartialUpdateFormat[keyof typeof EnvironmentsPersonsPartialUpdateFormat];
    ...
    export type EnvironmentsPersonsDeletePropertyCreateFormat = typeof EnvironmentsPersonsDeletePropertyCreateFormat[keyof typeof EnvironmentsPersonsDeletePropertyCreateFormat];
    ...
    export type EnvironmentsPersonsPropertiesTimelineRetrieveFormat = typeof EnvironmentsPersonsPropertiesTimelineRetrieveFormat[keyof typeof EnvironmentsPersonsPropertiesTimelineRetrieveFormat];
    ...
    export type EnvironmentsPersonsSplitCreateFormat = typeof EnvironmentsPersonsSplitCreateFormat[keyof typeof EnvironmentsPersonsSplitCreateFormat];
    ...
    export type EnvironmentsPersonsBatchByDistinctIdsCreateFormat = typeof EnvironmentsPersonsBatchByDistinctIdsCreateFormat[keyof typeof EnvironmentsPersonsBatchByDistinctIdsCreateFormat];
    ...
    export type EnvironmentsPersonsFunnelRetrieveFormat = typeof EnvironmentsPersonsFunnelRetrieveFormat[keyof typeof EnvironmentsPersonsFunnelRetrieveFormat];
    ...
    export type EnvironmentsPersonsFunnelCreateFormat = typeof EnvironmentsPersonsFunnelCreateFormat[keyof typeof EnvironmentsPersonsFunnelCreateFormat];
    ...
    export type EnvironmentsPersonsLifecycleRetrieveFormat = typeof EnvironmentsPersonsLifecycleRetrieveFormat[keyof typeof EnvironmentsPersonsLifecycleRetrieveFormat];
    ...
    export type EnvironmentsPersonsPropertiesAtTimeRetrieveFormat = typeof EnvironmentsPersonsPropertiesAtTimeRetrieveFormat[keyof typeof EnvironmentsPersonsPropertiesAtTimeRetrieveFormat];
    ...
    export type EnvironmentsPersonsResetPersonDistinctIdCreateFormat = typeof EnvironmentsPersonsResetPersonDistinctIdCreateFormat[keyof typeof EnvironmentsPersonsResetPersonDistinctIdCreateFormat];
    ...
    export type EnvironmentsPersonsTrendsRetrieveFormat = typeof EnvironmentsPersonsTrendsRetrieveFormat[keyof typeof EnvironmentsPersonsTrendsRetrieveFormat];
    ...
    * `twig` - twig
    ...
    export type DashboardsMoveTilePartialUpdateFormat = typeof DashboardsMoveTilePartialUpdateFormat[keyof typeof DashboardsMoveTilePartialUpdateFormat];
    ...
    export type DashboardsCreateFromTemplateJsonCreateFormat = typeof DashboardsCreateFromTemplateJsonCreateFormat[keyof typeof DashboardsCreateFromTemplateJsonCreateFormat];
    ...
    export type DashboardsCreateUnlistedDashboardCreateFormat = typeof DashboardsCreateUnlistedDashboardCreateFormat[keyof typeof DashboardsCreateUnlistedDashboardCreateFormat];
    ...
    * `-updated_at` - Updated At (descending)
    ...
    export type FeatureFlagsListEvaluationRuntime = typeof FeatureFlagsListEvaluationRuntime[keyof typeof FeatureFlagsListEvaluationRuntime];
    ...
    export type InsightsAnalyzeRetrieveFormat = typeof InsightsAnalyzeRetrieveFormat[keyof typeof InsightsAnalyzeRetrieveFormat];
    ...
    export type InsightsSuggestionsRetrieveFormat = typeof InsightsSuggestionsRetrieveFormat[keyof typeof InsightsSuggestionsRetrieveFormat];
    ...
    export type InsightsSuggestionsCreateFormat = typeof InsightsSuggestionsCreateFormat[keyof typeof InsightsSuggestionsCreateFormat];
    ...
    export type InsightsMyLastViewedRetrieveFormat = typeof InsightsMyLastViewedRetrieveFormat[keyof typeof InsightsMyLastViewedRetrieveFormat];
    ...
    * `running` - Running
    ...
    export type PersonsPropertiesAtTimeRetrieveFormat = typeof PersonsPropertiesAtTimeRetrieveFormat[keyof typeof PersonsPropertiesAtTimeRetrieveFormat];
    ...
    * `InitialChannelType` - InitialChannelType
    ...
    export type WebAnalyticsBreakdownRetrieveBreakdownBy = typeof WebAnalyticsBreakdownRetrieveBreakdownBy[keyof typeof WebAnalyticsBreakdownRetrieveBreakdownBy];
